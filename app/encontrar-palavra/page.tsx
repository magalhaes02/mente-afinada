import EncontrarPalavraView from "./EncontrarPalavraView";

export const metadata = { title: "Encontrar palavra · Mente Afinada" };

export default function EncontrarPalavraPage() {
  return (
    <main
      style={{
        minHeight: "100vh",
